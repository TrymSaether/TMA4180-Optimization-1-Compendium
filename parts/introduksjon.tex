...
\begin{remark}{Intuisjon -- supremum}{intuition_supremum}
	Tenk på supremum som \enquote{taket} eller \enquote{den laveste hindringen} over mengden. 
	
	Det er den minste verdien som fungerer som en øvre grense for alle elementer i mengden. Som et fysisk bilde: hvis elementene i mengden er hoppende baller, er supremum det laveste taket som ingen ball kan hoppe høyere enn.

	\textbf{Huskeregel:} \enquote{SUP-remum er den minste verdien SUpra (over) mengden} (tenk på \enquote{sup} som i \enquote{super} eller \enquote{ovenfor}).
\end{remark}
...
\subsection{Konveksitetekvivalenser}
